...
public class ExpiresDefault extends Directive {
	private final ExpirationTimeout timeout;
	...
	static class ExpirationTimeout {
	...
	@Override
	public String toString() {
		return "ExpiresDefault [node=" + node + ", timeout=" + timeout + "]";
	}

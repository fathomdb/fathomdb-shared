...
import com.fathomdb.jpa.impl.JoinedQueryResult.ObjectList;
import com.fathomdb.jpa.impl.ResultSetMapper;
			...
			if (batchExecute) {
				...
				if (isResultSet) {
					...
					if (returnType.equals(Void.class) || returnType.equals(void.class)) {
						...
						throw new IllegalArgumentException("Unhandled return type: " + returnType.getClass());
					}
				}
			}
		} finally {
